...

{
  ...
  readfile("a.txt", x5,  col, N);
  readfile("e.txt", x6,  col, N);
  readfile("i.txt", x7,  col, N);
  readfile("o.txt", x8,  col, N);
  readfile("u.txt", x9,  col, N);
